...
$APPLICATION->SetTitle("Каталог");
 if (isset($_GET['showArchive']) && $_GET['showArchive'] == '1') {
    $GLOBALS['obsoleteFilter']["PROPERTY_OBSOLETE"] = '-1';
} else {
    $GLOBALS['obsoleteFilter']["!PROPERTY_OBSOLETE"] = '-1';
}

global $mySmartFilter;
$mySmartFilter = ['!PROPERTY_OBSOLETE' => -1];

$PAGE_ELEMENT_COUNT = 20;
if (isset($_GET['SIZEN']) && (int)$_GET['SIZEN'] > 0) {
    $PAGE_ELEMENT_COUNT = $_GET['SIZEN'];
}
...
<?if(!CLOSE_CATALOG):?>
    <?$APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "DISPLAY_TOP_PAGER" => "N",
            "ELEMENT_SORT_FIELD" => $GLOBALS["sorting"],
            "ELEMENT_SORT_FIELD2" => "id",
            "ELEMENT_SORT_ORDER" => $GLOBALS["ordering"],
