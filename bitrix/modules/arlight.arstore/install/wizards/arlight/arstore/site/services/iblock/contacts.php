...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/showroom/index.php", array("STORES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/buy/index.php", array("STORES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/contacts/index.php", array("STORES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/admin/settings/settings-main/edit-store/index.php", array("STORES_IBLOCK_ID" => $iblockID));

CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("STORES_IBLOCK_ID" => $iblockID));

$bitrixTemplateDir = $_SERVER["DOCUMENT_ROOT"] . "/local/templates/";
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "arlight/footer.php", array("STORES_IBLOCK_ID" => $iblockID));
