...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/scheme.xml";
$iblockCode = "scheme";
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/arrangement/index.php", array("SCHEME_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/search/index.php", array("SCHEME_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("SCHEME_IBLOCK_ID" => $iblockID));
