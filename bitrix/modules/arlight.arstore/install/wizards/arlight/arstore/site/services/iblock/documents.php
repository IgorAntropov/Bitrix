...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/doc_catalogs.xml";
$iblockCode = "documents";
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/documents/index.php", array("DOC_CATALOG_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("DOC_CATALOG_IBLOCK_ID" => $iblockID));
