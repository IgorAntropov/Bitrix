		...
		<tbody>
					...
					<td>
						...
						<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
							...
							case "N":
								...
								?>
								<input type="text" class="form-control" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]; ?>" value="<?=$value?>" /><br /><?
								if($arResult["PROPERTY_LIST_FULL"][$propertyID]["USER_TYPE"] == "DateTime"):?><?
									...
									?><br /><small><?=GetMessage("IBLOCK_FORM_DATE_FORMAT")?><?=FORMAT_DATETIME?></small><br /><?
								endif
								?><?
								}
							break;
						...
						<input type="file" class="form-control-file" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>"  name="PROPERTY_FILE_<?=$propertyID?>_<?=$arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] ? $arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] : $i?>" />
									<?
									...
									if (!empty($value) && is_array($arResult["ELEMENT_FILES"][$value]))
									{
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label for="file_delete_<?= $propertyID ?>_<?= $i ?>" class="form-check-label"><?= GetMessage("IBLOCK_FORM_FILE_DELETE") ?></label>
                                        </div>
										<?
										...
										{
											?>
                                            <div class="edit-store-img">
                                                <a data-fancybox="store" href="<?= $arResult["ELEMENT_FILES"][$value]["SRC"] ?>">
			...
			<?if($arParams["USE_CAPTCHA"] == "Y" && $arParams["ID"] <= 0):?>
				...
				<tr>
					...
					<td><input type="text" class="form-control" name="captcha_word" maxlength="50" value=""></td>
				</tr>
			<?endif?>
		</tbody>
		<?endif?>
			...
			<tr>
				<td colspan="2">
					...
					<?if ($arParams["LIST_URL"] <> ''):?>
						<input type="submit" name="iblock_apply" class="btn btn-primary" value="<?=GetMessage("IBLOCK_FORM_APPLY")?>" />
						<input
