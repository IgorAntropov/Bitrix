...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/event.xml";
$iblockCode = "events";
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/webarchive/index.php", array("WEBARCHIVE_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("WEBARCHIVE_IBLOCK_ID" => $iblockID));
