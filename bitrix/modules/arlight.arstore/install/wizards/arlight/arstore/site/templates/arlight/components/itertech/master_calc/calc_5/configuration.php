...
$masterCalcConfiguration = array(
    ...
    'items' => array(
        ...
        array(
            ...
            'fieldType' => 'text',
            'name' => 'Uvih',
            'title' => GetMessage("ARLIGHT_ARSTORE_NAPRAJENIE_NA_LENTE"),
            'inputClass' => 'input-with-btns'
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_5_findProductByItemNumber',
            'validation' => array(
                'no_validation',
            ),
        ...
        array(
            ...
            'type' => 'formula',
            'name' => 'Uvh',
            'title' => GetMessage("ARLIGHT_ARSTORE_TREBUEMOE_NAPRAJENIE"),
            'formula' => '[Uvih]+4*(0,017*[P]*[L])/(3*[Uvih]*[S])',
            'visible' => false
        ),
        ...
        array(
            ...
            'name' => 'Uvhr',
            'title' => GetMessage("ARLIGHT_ARSTORE_TREBUEMOE_NAPRAJENIE1"),
            'unit' => GetMessage("ARLIGHT_ARSTORE_V"),
            'defaultValue' => '',
            'onCalculation' => 'calc_5_functionAddFinalText'
        ),
    ),
);

function calc_5_functionAddFinalText($index, &$items)
{
    $item = &$items[$index];
...
function calc_5_findProductByItemNumber($index, &$items)
{
    global $DB;
