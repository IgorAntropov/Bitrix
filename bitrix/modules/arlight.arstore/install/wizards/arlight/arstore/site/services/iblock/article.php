...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/article.xml";
$iblockCode = "articles";
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/articles/index.php", array("ARTICLE_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/" . WIZARD_SITE_ID . "/init.php", array("ARTICLE_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . '/search/index.php', array("ARTICLE_IBLOCK_ID" => $iblockID));
?>
