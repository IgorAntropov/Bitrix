...
$masterCalcConfiguration = array(
    ...
    'items' => array(
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_3_findProductByItemNumber',
            'validation' => array(
                'no_validation',
            ),
        ...
        array(
            ...
            'formula' => '[Uvih]+2*(0,017*[P]*[L])/([Uvih]*[S])',
            'visible' => false
        ),
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_3_functionAddFinalText'
        ),
    ),
);

function calc_3_functionAddFinalText($index, &$items)
{
    $item = &$items[$index];
...
function calc_3_findProductByItemNumber($index, &$items)
{
    global $DB;
