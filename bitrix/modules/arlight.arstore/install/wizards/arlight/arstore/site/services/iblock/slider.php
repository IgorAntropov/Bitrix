...
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "arlight/header.php", array("SLIDER_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("SLIDER_IBLOCK_ID" => $iblockID));
?>
