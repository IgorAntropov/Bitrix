...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/certificate.xml";
$iblockCode = "CERTIFICATES_FROM_BASE";
$iblockType = "content";
...
//CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/video/index.php", array("VIDEO_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("CERTIFICATES_FROM_BASE_IBLOCK_ID" => $iblockID));
