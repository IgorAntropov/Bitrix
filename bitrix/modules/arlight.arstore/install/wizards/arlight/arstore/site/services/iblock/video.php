...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/search/index.php", array("VIDEO_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/video/index.php", array("VIDEO_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("VIDEO_IBLOCK_ID" => $iblockID));
