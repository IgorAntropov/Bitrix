...
$MESS["REGISTER_FIELD_NAME"] = "Имя Фамилия";
...
$MESS["ARLIGHT_ARSTORE_NAJIMAA_KNOPKU_REGI"] = "Нажимая кнопку «Регистрация», я подтверждаю свою дееспособность, даю своё согласие на обработку
                        персональных данных в соответствии с ";
$MESS["ARLIGHT_ARSTORE_POLITIKOY_OBRABOTKI"] = "Политикой обработки
                            персональных данных";
$MESS["ARLIGHT_ARSTORE_PAROLQ_DOLJEN_BYTQ_N"] = "Пароль должен быть не менее 6 символов длиной.";
?>