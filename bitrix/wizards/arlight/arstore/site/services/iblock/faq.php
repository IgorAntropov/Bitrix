...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/faq/index.php", array("FAQ_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("FAQ_IBLOCK_ID" => $iblockID));
