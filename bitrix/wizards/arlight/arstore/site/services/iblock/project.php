...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/project.xml";
$iblockCode = "projects";
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/projects/index.php", array("PROJECT_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("PROJECT_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/search/index.php", array("PROJECT_IBLOCK_ID" => $iblockID));
