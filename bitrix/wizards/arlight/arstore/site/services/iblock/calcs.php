...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/calcs.xml";
$iblockCode = "CALC";
$iblockType = "service";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/info/calc/index.php", array("CALC_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("CALC_IBLOCK_ID" => $iblockID));
