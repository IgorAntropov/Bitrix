...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/subscribe_results.xml";
$iblockCode = "subscribe_form";
$iblockType = "service";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/local/php_interface/".WIZARD_SITE_ID."/init.php", array("SUBSCRIBE_RESULT_IBLOCK_ID" => $iblockID));
