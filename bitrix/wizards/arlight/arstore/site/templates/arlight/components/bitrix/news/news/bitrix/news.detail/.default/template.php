...
$picturesFromArlight = [];
$pictJson = $_SERVER["DOCUMENT_ROOT"]. SITE_DIR . 'assets/json/jsonPicturesForProjects.json';
if(file_exists($pictJson)){
    $picturesFromArlight = json_decode(json_encode(json_decode(file_get_contents($pictJson))), true);
}
$code = $arResult['CODE'];
global $arFilterForLastNews;
?>
<div class="content content--block news-detail">
    <div class="row">
        <div class="col-lg-9">
            <div>
                ...
                <? if(isset($picturesFromArlight[$code])): ?>
                        <div class="content__slider">
                            <? foreach ($picturesFromArlight[$code] as $pictureSRC) : ?>
                                <div class="slide">
                                    <div class="slide__img">
                                        <a href="<?= $pictureSRC ?>" data-fancybox="gallery">
                        ...
                        <div class="content__slider-nav">
                            <? foreach ($picturesFromArlight[$code] as $pictureSRC) : ?>
                                <div class="slide">
                                    <div class="slide__img">
                                        <div class="" style="overflow: hidden; width: 95px; height: 60px; margin-top: 20px;">
                                            <img src="<?= $pictureSRC ?>" alt="" style="width: 95px; height: auto; ">
                                        </div>
                                    </div>
                                </div>
                            <? endforeach; ?>
                    ...
                    <? if ($arResult['DISPLAY_PROPERTIES']['PICTURES']): ?>
                        ...
                        <div class="content__slider-nav">
                            <? foreach ($arImg as $img) : ?>
                                <div class="slide">
                                    <div class="slide__img">
                                        <img src="<? ALResizeH($img, 95,60) ?>" alt="">
                                    </div>
                                </div>
                            <? endforeach; ?>
                        </div>
                ...
                <div class="content__text">
                    <? if ($arResult["IBLOCK_CODE"] == 'scheme'): ?>
                    <p style="text-align: center">
                        <img src="<?= $arResult['DETAIL_PICTURE']['SRC'] ?>" alt="">
                    </p>
                    <? endif; ?>
                    <?
                    if($_SERVER['REAL_FILE_PATH'] == SITE_DIR . 'info/projects/index.php'){
                        $checkDetail = $arResult["DETAIL_TEXT"];
                        $realization = GetMessage("ARLIGHT_ARSTORE_REALIZACIA_PROEKTA");
                        if($code == 'magazin-toptop-sankt-peterburg') $realization = GetMessage("ARLIGHT_ARSTORE_REALIZACIA");
                        $check1 = explode($realization, $checkDetail);
                        $check2 = explode(GetMessage("ARLIGHT_ARSTORE_MATERIAL_PREDOSTAVLE"), $checkDetail);
                        $check3 = explode(GetMessage("ARLIGHT_ARSTORE_DIZAYNER_PROEKTA"), $checkDetail);
                        if(count($check1) == 2 || count($check2) == 2 || count($check3) == 2){
                            $arResult["DETAIL_TEXT"] = explode($realization, explode(GetMessage("ARLIGHT_ARSTORE_MATERIAL_PREDOSTAVLE"), explode(GetMessage("ARLIGHT_ARSTORE_DIZAYNER_PROEKTA"), $checkDetail)[0])[0])[0];
                            $arResult["DETAIL_TEXT"].='<br><p>'.GetMessage("ARLIGHT_ARSTORE_MATERIAL_RAZMESEN_NA").'</a></p>';
                        }
                    }
                    ?>
                ...
                <? if ($arResult['IBLOCK_ID'] == NEWS_ID): ?>
                    ...
                    <div class="news-last">
                        <? $APPLICATION->IncludeComponent("bitrix:news.list", "last-news", Array(
                            ...
                            "FILTER_NAME" => "arFilterForLastNews",    // Фильтр
                            ...
                            "PAGER_TITLE" => GetMessage("ARLIGHT_ARSTORE_SLAYDER"),    // Название категорий
