    ...
    'items' => array(
        ...
        array(
            ...
            'values' => array(
                ...
                array('light_flow', GetMessage("ARLIGHT_ARSTORE_PO_SVETOVOMU_POTOKU")),
            ),
        ),
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_0_findProductByItemNumber',
            'validation' => array(
                'no_validation',
            ),
        ...
        array(
            ...
            'fieldType' => 'text',
            'name' => 'F',
            'attributes' => 'data-select-type="light_flow" data-select-block',
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_0_functionNDefine2',
            'visible' => false,
        ),
        ...
        array(
            ...
            'type' => 'formula',
            'name' => 'N',
            'title' => GetMessage("ARLIGHT_ARSTORE_RASSCITYVAEM_KOLICES"),
            'formula' => '([E]*[L]*[W]*[Kz])/([n]*[F])',
            'visible' => false,
        ),
        ...
        array(
            ...
            'type' => 'formula',
            'name' => 'Nc',
            'title' => GetMessage("ARLIGHT_ARSTORE_PRIMERNOE_KOLICESTVO"),
            'formula' => 'ceil([N])'
        ),
        ...
        array(
            ...
            'title' => GetMessage("ARLIGHT_ARSTORE_PRIMERNOE_KOLICESTVO"),
            'defaultValue' => '',
            'onCalculation' => 'calc_0_functionAddFinalText',
            'visible' => false,
        ),
    ),
);

function calc_0_functionAddFinalText($index, &$items)
{
    $item = &$items[$index];
...
function calc_0_functionNDefine($index, &$items)
{
    $ar = array(
        '705030' => array(
            array('0.5', '0.26'),
...
function calc_0_functionNDefine2($index, &$items)
{
    $n = false;
    $i = false;
    $ton = '705030';
...
function calc_1_functionArtDefine($index, &$items)
{
    return '015215';
}

function calc_1_myOnStart1($index, &$items)
{
}

function calc_0_findProductByItemNumber($index, &$items)
{
    global $DB;
    if (CModule::IncludeModule('iblock') && $items[$index]['result'] != '') {
        ...
        $res = CIBlockElement::GetList(
            ...
            false,
            false,
            array('ID', 'NAME', 'DETAIL_PAGE_URL', 'PROPERTY_ARTICLE', 'PROPERTY_N_8', 'PROPERTY_C_8_MAX')
        );
        if ($res) {
            $els = array();
            ...
            if (count($els)) {
                $n8 = array();
                foreach ($els as $el) {
                    if ($el['PROPERTY_C_8_MAX_VALUE'] != '') {
                        $n8[] = $el['PROPERTY_C_8_MAX_VALUE'];
                    }
                }
...
//                    $F['attributes'] = ' readonly="readonly" ';
                    ...
                    */
                    ...
                    $F['result'] = '';
//                    $F['attributes'] = '';
                    $items[$index]['messages'][] = GetMessage("ARLIGHT_ARSTORE_TOVAR").'<a href="' . $els[0]['DETAIL_PAGE_URL'] . '" target="_blank">' . $els[0]['NAME'] . '</a> '.GetMessage("ARLIGHT_ARSTORE_NAYDEN_NO_U_NEGO_NE");
                }
            } else {
                $F['result'] = '';
//                $F['attributes'] = '';
