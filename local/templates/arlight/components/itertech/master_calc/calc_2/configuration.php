...
$masterCalcConfiguration = array(
    ...
    'items' => array(
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_2_findProductByItemNumber',
            'validation' => array(
                'no_validation',
            ),
        ...
        array(
            ...
            'defaultValue' => '',
            'onCalculation' => 'calc_2_functionAddFinalText'
        ),
    ),
);

function calc_2_functionAddFinalText($index, &$items)
{
    $item = &$items[$index];
...
function calc_2_findProductByItemNumber($index, &$items)
{
    global $DB;
