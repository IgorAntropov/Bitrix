...
if (isset($arResult['ITEM']))
{
    ...
    if (preg_match("!/favorite/!si",$APPLICATION->GetCurPage())) {
        $rowFav = ' data-id="'.$item['ID'].'"  data-slug="FAVORITE_ROW"';
    }

    ?>

    <div class="item__main-block" itemscope itemtype="http://schema.org/Product" itemprop="itemListElement" id="<?= $areaId ?>" data-entity="item"<?=$rowFav;?>>
		<?
